...
class CustomChatBot:
    ...
    def import_source_document(self):
        ...
        for file in os.listdir('data'):
            if file.endswith('.txt'):
                with open(os.path.join('data',file))as f:
                    doc.append(os.path.join('data',f.read()))
                    files.append(file)
        ...
        system_message_prompt=SystemMessagePromptTemplate.from_template(
            """
            You are a chatbot tasked with responding to question based on attached website content below.
            {context}
    ...
    def main(self):
        ...
        if user_query:
            ...
            with st.chat_message("assistant"):
                ...
                utils.print_qa(CustomChatBot, user_query, response)
